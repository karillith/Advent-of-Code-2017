...
/*//////////////////////////////////////////////
	...
	- buh, still had to preg_replace/preg_match the ??? chars out, so it was just a little frustrating, but not terrible
...
foreach ($passphrase_list_lines as $passphrase_list_line) {
	...
	$original_count = count($passphrase_words);
	$unique_passphrase_words = array_unique($passphrase_words);
	$unique_count = count($unique_passphrase_words);
	if ($original_count == $unique_count) {
		$valid_passphrases++;
	} else {
		// print_r($passphrase_words);
		// print_r($unique_passphrase_words);
	}
	// echo count($passphrase_words)."\n";
}
